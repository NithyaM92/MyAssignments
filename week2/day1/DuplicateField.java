...
public class DuplicateField {
	...
	public static void main(String[] args) {
		...
		System.out.println("Updated page Titel is " + driver.getTitle());
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Tester Duplicate");
		driver.findElement(By.name("submitButton")).click();

		System.out.println("Duplicate title of the page is :"+driver.getTitle());
	}
